...
class NetMultiModal(nn.Module):

    def __init__(self, backbone, head):
        super(NetMultiModal, self).__init__()
        self.backbone = backbone
        self.head = head

    def forward(self, z_rgb, x_rgb, z_ir, x_ir):
        z = self.backbone(z_rgb, z_ir)
        x = self.backbone(x_rgb, x_ir)
...
class AlexNetV3(_AlexNet):
    ...
    def __init__(self, in_channels):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(in_channels, 192, 11, 2),
            _BatchNorm2d(192),
